...
export default function Login() {
  ...
  const onSubmit = async (formData: LoginForm | SignupForm) => {
    setLoading(true);
    setError("");
    ...
    try {
      ...
      if (isLogin) {
        ...
        if (!profile) {
          profile = getUserFromAuth(data.session);
        ...
        <div className="relative hidden overflow-hidden bg-gradient-to-br from-blue-700 via-blue-800 to-slate-900 lg:flex">
          ...
          <div className="relative z-10 flex flex-col justify-between w-full text-white p-14">
            <div>
              ...
              <h1 className="text-6xl font-black tracking-tight">IUGRID</h1>

              <p className="mt-5 text-2xl font-semibold text-blue-100">
                AI-Driven Smart Grievance Redressal & Decision Support System
              </p>

              <p className="max-w-xl mt-6 text-lg leading-8 text-slate-200">
                A secure and intelligent grievance platform designed for
                universities with AI-based complaint classification, tracking,
        ...
        <div className="flex items-center justify-center px-5 py-10">
          <div className="w-full max-w-lg">
            ...
            <div className="mb-8 text-center lg:hidden">
              <h1 className="text-4xl font-black text-blue-700">IUGRID</h1>
